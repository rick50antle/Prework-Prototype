...
// ===== MODULE MAP =====
var MODULES = [
  { num: 1, title: "Building the Accounting Identity", file: "module1-activities.html" },
...
var GLOSSARY = [
  ...
  { term: "Going concern", def: "The starting assumption underlying financial reporting that an entity will continue to operate for the foreseeable future. Under going concern, the records value assets in terms of what they contribute to ongoing operations, not what they would fetch in a wind-up sale. That permits a range of measurements \u2014 original cost, depreciation over expected useful life, impairment, lower of cost or market for inventory, fair value for many financial instruments \u2014 but rules out liquidation-basis accounting, where everything would be re-measured at expected wind-up values. Equities is therefore not \u201cwhat is left for owners after the entity is wound up\u201d; the records are not computed under any wind-up scenario. Both US GAAP (ASC 205-40) and IFRS (IAS 1) make the assumption explicit, and auditors must disclose substantial doubt that it holds." }
];
